      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-4xl mx-auto px-4 py-16 text-center">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
            ...
            your experience on IsThereSoftwareThat.com and how you can control
            them.
          </p>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 border border-slate-100 mb-12">
          ...
          <p className="text-slate-600 mb-6">
            ...
            different types of cookies, except for essential cookies which are
            ...
            <div className="flex items-start justify-between p-4 bg-slate-50 rounded-lg">
              ...
              <div className="ml-4 flex items-center">
                ...
                >
                  ...
                  <div
                    className={`p-1 rounded-full ${cookiePreferences.analytics ? "bg-green-500" : "bg-slate-400"}`}
                  >
            ...
            <div className="flex items-start justify-between p-4 bg-slate-50 rounded-lg">
              ...
              <div className="ml-4 flex items-center">
                ...
                >
                  ...
                  <div
                    className={`p-1 rounded-full ${cookiePreferences.functional ? "bg-green-500" : "bg-slate-400"}`}
                  >
            ...
            <div className="flex items-start justify-between p-4 bg-slate-50 rounded-lg">
              <div className="flex-1">
                ...
                <p className="text-slate-600 text-sm">
                  ...
                  relevant to you and may be set by third-party advertising
                  partners.
                </p>
              </div>
              <div className="ml-4 flex items-center">
                ...
                >
                  ...
                  <div
                    className={`p-1 rounded-full ${cookiePreferences.advertising ? "bg-green-500" : "bg-slate-400"}`}
                  >
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-700 leading-relaxed mb-2">
                These cookies are strictly necessary for our website to function
                properly:
              </p>
              <ul className="list-disc list-inside text-slate-700 space-y-2 mb-4">
                ...
                <li>
                  <strong>Load Balancing:</strong> Distribute traffic across our
                  servers
                </li>
              </ul>
              ...
              <ul className="list-disc list-inside text-slate-700 space-y-2 mb-4">
                <li>
                  <strong>Usage Statistics:</strong> Track page views, user
                  interactions, and popular content
                </li>
                <li>
                  <strong>Performance Monitoring:</strong> Identify slow-loading
                  pages and technical issues
                </li>
                <li>
                  <strong>User Journey Analysis:</strong> Understand how users
                  navigate through our site
                </li>
                <li>
                  <strong>A/B Testing:</strong> Test different versions of pages
              ...
              <ul className="list-disc list-inside text-slate-700 space-y-2 mb-4">
                ...
                <li>
                  <strong>Language Selection:</strong> Store your preferred
                  language
                </li>
                <li>
                  <strong>Theme Settings:</strong> Remember your dark/light mode
                  preference
                </li>
                <li>
                  <strong>Bookmarks:</strong> Store your saved software for
                  quick access
                </li>
              </ul>
              ...
              <ul className="list-disc list-inside text-slate-700 space-y-2 mb-4">
                <li>
                  <strong>Targeted Advertising:</strong> Show relevant ads based
                  on your interests
                </li>
                <li>
                  <strong>Frequency Capping:</strong> Limit how often you see
                  the same ad
                </li>
                <li>
                  <strong>Campaign Measurement:</strong> Measure the
                  effectiveness of advertising campaigns
                </li>
                <li>
                  <strong>Cross-Site Tracking:</strong> Track your activity
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-slate-700 space-y-2 mb-4">
                ...
                <li>
                  <strong>Content Delivery Networks:</strong> For faster loading
                  of website resources
                </li>
                <li>
                  <strong>Customer Support Tools:</strong> For live chat and
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-700 leading-relaxed mb-4">
                Use our cookie preference center above to control which types of
                cookies we set. Your preferences will be remembered for future
                visits.
              </p>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-slate-700 space-y-2 mb-4">
                <li>
                  <strong>Essential Cookies:</strong> The website may not
                  function properly
                </li>
                <li>
                ...
                <li>
                  <strong>Functional Cookies:</strong> You may lose personalized
                  features and preferences
                </li>
                <li>
                  <strong>Advertising Cookies:</strong> You may see less
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-slate-700 space-y-2 mb-4">
                ...
                <li>
                  <strong>Authentication Cookies:</strong> Typically 30 days or
                  until you log out
                </li>
                <li>
                ...
                <li>
                  <strong>Advertising Cookies:</strong> Varies by provider,
            ...
            <section>
              ...
              <div className="bg-slate-50 rounded-lg p-4">
                <p className="text-slate-700">
                  <strong>Email:</strong> privacy@istheresoftwarethat.com
                  <br />
        ...
        <div className="mt-12 text-center">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white">
            ...
            <p className="text-blue-100 mb-6">
              Learn more about how we protect your privacy and our terms of
              service.
            </p>
