          ...
          <div className="prose prose-slate max-w-none">
            <section className="mb-8">
              ...
              <p className="text-slate-700 leading-relaxed mb-4">
                When you create an account or interact with our service, we may
                collect:
              </p>
              <ul className="list-disc list-inside text-slate-700 space-y-2 mb-4">
                ...
                <li>
                  <strong>Profile Information:</strong> Optional profile details
                  you choose to share
                </li>
                <li>
              ...
              <ul className="list-disc list-inside text-slate-700 space-y-2 mb-4">
                ...
                <li>
                  ...
                  device (see our Cookie Policy for details)
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-slate-700 space-y-2 mb-4">
                ...
                <li>
                  Personalize your experience and provide relevant
                  recommendations
                </li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-slate-700 space-y-2 mb-4">
                <li>
                  Reviews, ratings, and comments you post are publicly visible
                </li>
                <li>
                  Your username may be displayed with your public contributions
                </li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-slate-700 space-y-2 mb-4">
                ...
                <li>
                  ...
                  and update our security practices
                </li>
                <li>
                  <strong>Secure Infrastructure:</strong> We use reputable cloud
                  providers with strong security standards
                </li>
              </ul>
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-700 leading-relaxed mb-4">
                ...
                experience. Our cookies help us:
              </p>
              <ul className="list-disc list-inside text-slate-700 space-y-2 mb-4">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-slate-700 space-y-2 mb-4">
                ...
                <li>
                  <strong>User Content:</strong> Until you delete it or your
                  account is deleted
                </li>
                <li>
                  <strong>Usage Data:</strong> Typically 2-3 years for analytics
                  purposes
                </li>
                <li>
                  <strong>Legal Requirements:</strong> As required by applicable
                  law
                </li>
              </ul>
            </section>
