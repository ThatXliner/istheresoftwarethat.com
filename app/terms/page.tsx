      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-4xl mx-auto px-4 py-16 text-center">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
            ...
            IsThereSoftwareThat.com. By accessing our service, you agree to be
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 border border-slate-100">
          <div className="prose prose-slate max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-700 leading-relaxed mb-4">
                IsThereSoftwareThat.com is a catalog and discovery platform for
                free and open-source software. We provide:
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-700 leading-relaxed mb-4">
                Users may submit content including reviews, ratings, software
                submissions, and comments. By submitting content, you:
              </p>
              <ul className="list-disc list-inside text-slate-700 space-y-2 mb-4">
                <li>
                  Grant us a non-exclusive, royalty-free license to use, modify,
                  and display your content
                </li>
                <li>
                  Represent that you own or have permission to use the content
                </li>
                <li>
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-700 leading-relaxed mb-4">
                ...
                functionality are owned by IsThereSoftwareThat.com and are
                protected by international copyright, trademark, patent, trade
                secret, and other intellectual property laws.
              </p>
              <p className="text-slate-700 leading-relaxed mb-4">
                Software listed in our catalog remains the property of their
                respective owners. We do not claim ownership of any third-party
                software or content.
              </p>
              <p className="text-slate-700 leading-relaxed">
                Our logo, trademarks, and service marks may not be used without
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-700 leading-relaxed mb-4">
                Our Service contains links to third-party websites and software.
              ...
              <ul className="list-disc list-inside text-slate-700 space-y-2 mb-4">
                ...
                <li>
                  The functionality, security, or reliability of third-party
                  software
                </li>
                <li>
                  Any damages resulting from your use of third-party software
                </li>
                <li>
                  The availability or continued operation of external links
                </li>
              </ul>
              <p className="text-slate-700 leading-relaxed">
                You download and use third-party software at your own risk. We
                recommend reviewing the terms and licenses of any software
                before installation.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-700 leading-relaxed mb-4">
                ...
                IsThereSoftwareThat.com be liable for any indirect, incidental,
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-700 leading-relaxed">
                ...
                IsThereSoftwareThat.com and its officers, directors, employees,
            ...
            <section>
              ...
              <div className="bg-slate-50 rounded-lg p-4">
                <p className="text-slate-700">
                  <strong>Email:</strong> legal@istheresoftwarethat.com
                  <br />
