        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center">
              <span className="text-xl font-bold text-blue-400">IsThereSoftware</span>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <FooterLink to="/search?category=productivity" label="Productivity" />
              <FooterLink to="/search?category=development" label="Development" />
              <FooterLink to="/search?category=design" label="Design" />
              <FooterLink to="/search?category=communication" label="Communication" />
            </ul>
          </div>
